...
class SecureStorageService {
  ...
  Future<String?> readAuthToken() => _storage.read(key: StringConstants.authTokenKey);

  Future<void> deleteAuthToken() => _storage.delete(key: StringConstants.authTokenKey);
