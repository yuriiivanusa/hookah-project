...
TasteProfileDto2 _$TasteProfileDto2FromJson(Map<String, dynamic> json) => TasteProfileDto2(
...
Map<String, dynamic> _$TasteProfileDto2ToJson(TasteProfileDto2 instance) => <String, dynamic>{
...
CuratedMixDto _$CuratedMixDtoFromJson(Map<String, dynamic> json) => CuratedMixDto(
  ...
  components: (json['components'] as List<dynamic>)
      ...
      .toList(),
  expectedProfile: TasteProfileDto2.fromJson(json['expectedProfile'] as Map<String, dynamic>),
...
Map<String, dynamic> _$CuratedMixDtoToJson(CuratedMixDto instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
